...
function Change(element) {
	document.getElementById("enter").value += String(element)
}

function Calcul() {
	var an = document.getElementById("enter").value
	var lexemes = an.match(/\(|\)|\+|\-|\*|\/|\^|\d+\.\d*|\d+|sqrt|x|sin|cos|tan|cot|pi|e/gi)
	var cal = new Calc(lexemes)
	let a = cal.Calculate()

	document.getElementById("enter").value = String(a)
}
